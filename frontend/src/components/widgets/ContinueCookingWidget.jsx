...
export default function ContinueCookingWidget() {
    ...
    return (
        <Link
            to={`/cooking?recipeId=${mockRecipeId}`}
            className="card group col-span-1 block overflow-hidden rounded-2xl transition-transform hover:-translate-y-0.5 hover:shadow-soft-lg flex flex-col"
        >
            <div className="relative aspect-video bg-cream-200">
                ...
                />
                <div className="absolute left-2.5 top-2.5 rounded-full bg-amber px-2.5 py-0.5 text-xs font-bold text-white shadow-sm">
                    Continue Cooking
                </div>
            </div>
            <div className="p-4 flex-1 flex flex-col justify-between">
                <h3 className="line-clamp-1 text-base font-bold text-ink">Roasted Vegetable Lasagna</h3>
